...
**Phase 1 — Design:**
5. Generate `plan.md` from template (`.claude/commands/prizmkit-plan/assets/plan-template.md`):
...
The plan template is located at `.claude/commands/prizmkit-plan/assets/plan-template.md`.
