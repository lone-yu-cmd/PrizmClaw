...
6. Generate `spec.md` from template (`.claude/command-assets/prizmkit-specify/assets/spec-template.md`) focusing on:
...
The spec template is located at `.claude/command-assets/prizmkit-specify/assets/spec-template.md`.
