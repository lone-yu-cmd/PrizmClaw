...
4. Generate REGISTRY entry:
   ...
   - Data model changes
   - Completion date
5. Append to `.prizmkit/specs/REGISTRY.md` (create from template `.claude/command-assets/prizmkit-summarize/assets/registry-template.md` if not exists)
...
The registry template is located at `.claude/command-assets/prizmkit-summarize/assets/registry-template.md`.
