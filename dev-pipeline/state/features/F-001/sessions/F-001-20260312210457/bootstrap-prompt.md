...
- **Session ID**: F-001-20260312210457
- **Feature ID**: F-001
...
```bash
python3 /Users/wylonyu/selfProjects/PrizmClaw/dev-pipeline/scripts/init-dev-team.py --project-root /Users/wylonyu/selfProjects/PrizmClaw --feature-id F-001 --feature-slug 001-project-infrastructure-setup
```
...
- Spawn PM agent (Task tool, subagent_type="prizm-dev-team-pm", run_in_background=false)
  Prompt: "Read /Users/wylonyu/selfProjects/PrizmClaw/.codebuddy/agents/prizm-dev-team-pm.md. For feature F-001 (slug: 001-project-infrastructure-setup), complete all three planning steps in this single session:
...
- Spawn Reviewer agent (Task tool, subagent_type="prizm-dev-team-reviewer", run_in_background=false)
  Prompt: "Read /Users/wylonyu/selfProjects/PrizmClaw/.codebuddy/agents/prizm-dev-team-reviewer.md. Run prizmkit-analyze for feature F-001 (slug: 001-project-infrastructure-setup). Cross-check `.prizmkit/specs/001-project-infrastructure-setup/spec.md`, `plan.md`, and `tasks.md` for consistency. Report any CRITICAL or HIGH issues."
...
- Spawn Dev agent (Task tool, subagent_type="prizm-dev-team-dev", run_in_background=false)
  Prompt: "Read /Users/wylonyu/selfProjects/PrizmClaw/.codebuddy/agents/prizm-dev-team-dev.md. Implement all tasks for feature F-001 (slug: 001-project-infrastructure-setup) using prizmkit-implement with TDD. Read the plan from `.prizmkit/specs/001-project-infrastructure-setup/plan.md` and tasks from `tasks.md`. Mark completed tasks [x] in tasks.md."
- **Wait for Dev to return**
- All tasks marked `[x]`, tests pass

#### Phase 6: Review
- Spawn Reviewer agent (Task tool, subagent_type="prizm-dev-team-reviewer", run_in_background=false)
  Prompt: "Read /Users/wylonyu/selfProjects/PrizmClaw/.codebuddy/agents/prizm-dev-team-reviewer.md. For feature F-001 (slug: 001-project-infrastructure-setup):
...
Write to: `/Users/wylonyu/selfProjects/PrizmClaw/dev-pipeline/state/features/F-001/sessions/F-001-20260312210457/session-status.json`

```json
{
  "session_id": "F-001-20260312210457",
  "feature_id": "F-001",
...
| Session Status Output | /Users/wylonyu/selfProjects/PrizmClaw/dev-pipeline/state/features/F-001/sessions/F-001-20260312210457/session-status.json |
