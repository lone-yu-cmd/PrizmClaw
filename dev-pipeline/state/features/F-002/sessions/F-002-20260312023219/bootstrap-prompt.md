...
- **Session ID**: F-002-20260312023219
- **Feature ID**: F-002
...
```bash
python3 /Users/loneyu/SelfProjects/PrizmClaw/dev-pipeline/scripts/init-dev-team.py --project-root /Users/loneyu/SelfProjects/PrizmClaw --feature-id F-002 --feature-slug 002-telegram-pipeline-command-router
```
...
Write to: `/Users/loneyu/SelfProjects/PrizmClaw/dev-pipeline/state/features/F-002/sessions/F-002-20260312023219/session-status.json`

```json
{
  "session_id": "F-002-20260312023219",
  "feature_id": "F-002",
...
| Session Status Output | /Users/loneyu/SelfProjects/PrizmClaw/dev-pipeline/state/features/F-002/sessions/F-002-20260312023219/session-status.json |
