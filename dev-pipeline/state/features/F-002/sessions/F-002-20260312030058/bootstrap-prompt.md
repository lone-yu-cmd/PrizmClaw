...
- **Session ID**: F-002-20260312030058
- **Feature ID**: F-002
...
Write to: `/Users/loneyu/SelfProjects/PrizmClaw/dev-pipeline/state/features/F-002/sessions/F-002-20260312030058/session-status.json`

```json
{
  "session_id": "F-002-20260312030058",
  "feature_id": "F-002",
...
| Session Status Output | /Users/loneyu/SelfProjects/PrizmClaw/dev-pipeline/state/features/F-002/sessions/F-002-20260312030058/session-status.json |
