...
- **Session ID**: F-003-20260312031937
- **Feature ID**: F-003
...
1. Read artifacts in `.prizmkit/specs/003-feature-and-bug-plan-ingestion/` (spec.md, plan.md, tasks.md)
...
Write to: `/Users/loneyu/SelfProjects/PrizmClaw/dev-pipeline/state/features/F-003/sessions/F-003-20260312031937/session-status.json`

```json
{
  "session_id": "F-003-20260312031937",
  "feature_id": "F-003",
...
| Session Status Output | /Users/loneyu/SelfProjects/PrizmClaw/dev-pipeline/state/features/F-003/sessions/F-003-20260312031937/session-status.json |
