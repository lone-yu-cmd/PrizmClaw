...
- **Session ID**: F-004-20260312033516
- **Feature ID**: F-004
...
Write to: `/Users/loneyu/SelfProjects/PrizmClaw/dev-pipeline/state/features/F-004/sessions/F-004-20260312033516/session-status.json`

```json
{
  "session_id": "F-004-20260312033516",
  "feature_id": "F-004",
...
| Session Status Output | /Users/loneyu/SelfProjects/PrizmClaw/dev-pipeline/state/features/F-004/sessions/F-004-20260312033516/session-status.json |
