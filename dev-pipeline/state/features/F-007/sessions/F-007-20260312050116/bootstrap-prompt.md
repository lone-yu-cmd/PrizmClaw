...
- **Session ID**: F-007-20260312050116
- **Feature ID**: F-007
...
1. Read artifacts in `.prizmkit/specs/007-test-and-validation-suite/` (spec.md, plan.md, tasks.md)
...
Write to: `/Users/loneyu/SelfProjects/PrizmClaw/dev-pipeline/state/features/F-007/sessions/F-007-20260312050116/session-status.json`

```json
{
  "session_id": "F-007-20260312050116",
  "feature_id": "F-007",
...
| Session Status Output | /Users/loneyu/SelfProjects/PrizmClaw/dev-pipeline/state/features/F-007/sessions/F-007-20260312050116/session-status.json |
