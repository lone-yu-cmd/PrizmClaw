...
- **Session ID**: F-008-20260312051337
- **Feature ID**: F-008
...
Write to: `/Users/loneyu/SelfProjects/PrizmClaw/dev-pipeline/state/features/F-008/sessions/F-008-20260312051337/session-status.json`

```json
{
  "session_id": "F-008-20260312051337",
  "feature_id": "F-008",
...
| Session Status Output | /Users/loneyu/SelfProjects/PrizmClaw/dev-pipeline/state/features/F-008/sessions/F-008-20260312051337/session-status.json |
