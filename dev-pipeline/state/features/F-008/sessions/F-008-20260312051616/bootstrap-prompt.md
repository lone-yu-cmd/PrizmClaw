...
- **Session ID**: F-008-20260312051616
- **Feature ID**: F-008
...
- **Init Status**: true | Artifacts: spec=true plan=true tasks=false
...
```bash
python3 /Users/loneyu/SelfProjects/PrizmClaw/dev-pipeline/scripts/init-dev-team.py --project-root /Users/loneyu/SelfProjects/PrizmClaw --feature-id F-008 --feature-slug 008-commit-workflow-integration
```
...
- Spawn PM agent (Task tool, subagent_type="prizm-dev-team-pm", run_in_background=false)
  Prompt: "Read /Users/loneyu/SelfProjects/PrizmClaw/.codebuddy/agents/prizm-dev-team-pm.md. For feature F-008 (slug: 008-commit-workflow-integration), complete all three planning steps in this single session:
...
- Spawn Dev agent (Task tool, subagent_type="prizm-dev-team-dev", run_in_background=false)
  Prompt: "Read /Users/loneyu/SelfProjects/PrizmClaw/.codebuddy/agents/prizm-dev-team-dev.md. Implement all tasks for feature F-008 (slug: 008-commit-workflow-integration) using prizmkit-implement with TDD. Read the plan from `.prizmkit/specs/008-commit-workflow-integration/plan.md` and tasks from `tasks.md`. Mark completed tasks [x] in tasks.md."
- **Wait for Dev to return**
- All tasks marked `[x]`, tests pass

#### Phase 6: Review
- Spawn Reviewer agent (Task tool, subagent_type="prizm-dev-team-reviewer", run_in_background=false)
  Prompt: "Read /Users/loneyu/SelfProjects/PrizmClaw/.codebuddy/agents/prizm-dev-team-reviewer.md. For feature F-008 (slug: 008-commit-workflow-integration):
...
Write to: `/Users/loneyu/SelfProjects/PrizmClaw/dev-pipeline/state/features/F-008/sessions/F-008-20260312051616/session-status.json`

```json
{
  "session_id": "F-008-20260312051616",
  "feature_id": "F-008",
...
| Session Status Output | /Users/loneyu/SelfProjects/PrizmClaw/dev-pipeline/state/features/F-008/sessions/F-008-20260312051616/session-status.json |
