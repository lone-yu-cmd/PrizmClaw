...
- **Feature ID**: F-018 | **Session**: F-018-20260322142245 | **Run**: run-20260322-013453
...
**Before spawning Dev**, write a preliminary session-status.json to `/Users/loneyu/SelfProjects/PrizmClaw/dev-pipeline/state/features/F-018/sessions/F-018-20260322142245/session-status.json`:
```json
{
  "status": "partial",
  "current_phase": 3,
  "feature_id": "F-018",
  "session_id": "F-018-20260322142245",
...
Write to: `/Users/loneyu/SelfProjects/PrizmClaw/dev-pipeline/state/features/F-018/sessions/F-018-20260322142245/session-status.json`
...
**5c. Update session-status.json to success** — After commit succeeds, update `/Users/loneyu/SelfProjects/PrizmClaw/dev-pipeline/state/features/F-018/sessions/F-018-20260322142245/session-status.json`:
- Set `"status": "success"`
...
| Session Status Output | /Users/loneyu/SelfProjects/PrizmClaw/dev-pipeline/state/features/F-018/sessions/F-018-20260322142245/session-status.json |
